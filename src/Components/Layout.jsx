...
import { LayoutDashboard, FileText, UserCircle, LogOut, Menu, X, ChevronRight, Zap } from 'lucide-react';
...
const Layout = ({ children }) => {
    ...
    const menuItems = [
        { icon: <LayoutDashboard size={20} />, label: 'Dashboard', path: '/profile' }, // Assuming /profile is dashboard
        { icon: <FileText size={20} />, label: 'Invoice Generator', path: '/invoice' },
        { icon: <Zap size={20} />, label: 'Bulk Verify', path: '/verify' },
        ...
        <div className="flex h-screen bg-slate-950 text-slate-200 overflow-hidden font-sans">
            ...
            >
                ...
                <div className="h-16 flex items-center justify-between px-4 border-b border-slate-800">
                    {sidebarOpen ? (
                        <div className="flex items-center gap-2 font-bold text-xl text-cyan-400 tracking-tight">
                        ...
                        <div className="w-8 h-8 bg-cyan-500 rounded-lg flex items-center justify-center text-slate-900 mx-auto">
                            <Zap size={20} fill="currentColor" />
                        </div>
                    )}
                    <button
